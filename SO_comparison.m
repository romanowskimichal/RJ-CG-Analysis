...
T216 = readtable(f216);
%...
f78 = 'badanie_analiza_wynikow_2/badanie_analiza_wynikow_2/outputZ78.2_with_averaging_data.dat';
T78 = readtable(f78);
f79 = 'badanie_analiza_wynikow_2/badanie_analiza_wynikow_2/outputZ79.2_with_averaging_data.dat';
T79 = readtable(f79);
f80 = 'badanie_analiza_wynikow_2/badanie_analiza_wynikow_2/outputZ80.2_with_averaging_data.dat';
T80 = readtable(f80);
f81 = 'badanie_analiza_wynikow_2/badanie_analiza_wynikow_2/outputZ81.2_with_averaging_data.dat';
T81 = readtable(f81);
f82 = 'badanie_analiza_wynikow_2/badanie_analiza_wynikow_2/outputZ82.2_with_averaging_data.dat';
T82 = readtable(f82);
f83 = 'badanie_analiza_wynikow_2/badanie_analiza_wynikow_2/outputZ83.2_with_averaging_data.dat';
T83 = readtable(f83);
...
%...
P25 = plot (T210.Time_s_, T210.Thrust_N_, T96.Time_s_, T96.Thrust_N_, T78.Time_s_, T78.Thrust_N_, T79.Time_s_, T79.Thrust_N_, T80.Time_s_, T80.Thrust_N_);
legend({'Z210avg_T10','Z96avg_T10','Z78avg_T1,25','Z79avg_T1,25','Z80avg_T1,25'},'Location','northeast','Orientation','vertical');
title('RJ-Delay0-Time10-Thrust');
xlabel('Time [s]');
ylabel('Thrust [N]');
saveas(gcf, 'badanie_analiza_wynikow_MATLAB/_RJ-D0-T10-T1_25-Thrust.fig');
saveas(gcf, 'badanie_analiza_wynikow_MATLAB/_RJ-D0-T10-T1_25-Thrust.png');

P26 = plot (T210.Time_s_, T210.Thrust_N_, T96.Time_s_, T96.Thrust_N_, T81.Time_s_, T81.Thrust_N_, T82.Time_s_, T82.Thrust_N_, T83.Time_s_, T83.Thrust_N_);
legend({'Z210avg_T10','Z96avg_T10','Z81avg_T1,5','Z82avg_T1,5','Z83avg_T1,5'},'Location','northeast','Orientation','vertical');
title('RJ-Delay0-Time10-Thrust');
xlabel('Time [s]');
ylabel('Thrust [N]');
saveas(gcf, 'badanie_analiza_wynikow_MATLAB/_RJ-D0-T10-T1_5-Thrust.fig');
saveas(gcf, 'badanie_analiza_wynikow_MATLAB/_RJ-D0-T10-T1_5-Thrust.png');
